...
public class HistoriaClinicaController {
    ...
    public Optional<HistoriaClinica> consultarHistoriaPaciente(@PathVariable("idPaciente") Integer idPaciente) {
    ...
    public Optional<HistoriaClinica> consultarHistoriaVeterinario(@PathVariable("idVeterinario") Integer idVeterinario) {
