...
public class AgendaController {
    ...
    public List<Cita> consultarCitaPorVeterinario(@PathVariable Integer idVeterinario) {
        return agendaService.consultarCitaPorVeterinario(idVeterinario);
    }

    @GetMapping("/cita/paciente/{idPaciente}")
    public List<Cita> consultarCitaPorPaciente(@PathVariable Integer idPaciente) {
