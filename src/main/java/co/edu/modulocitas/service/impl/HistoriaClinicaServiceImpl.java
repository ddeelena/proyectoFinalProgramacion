...
public class HistoriaClinicaServiceImpl implements HistoriaClinicaService {
    ...
    @Override
    public Optional<HistoriaClinica> consultarHistoriaPaciente(Integer idPaciente) {
    ...
    @Override
    public Optional<HistoriaClinica> consultarHistoriaPorIdVeternario(Integer idVeternario) {
